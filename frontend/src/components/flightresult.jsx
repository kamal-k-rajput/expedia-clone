...
return (<div className="flightresultpage">
<div className="navbar">
    <div>Return <IoIosArrowDown/></div>
    <div onClick={openpopup}>Traveller <IoIosArrowDown/></div>
    <div><Dropdown  selected={selected} setSelected={setSelected}/></div>
    <div>Any Airline <IoIosArrowDown/></div>
    <div>More options <IoIosArrowDown/></div>
...
<div className="inputdiv2">
   <div className="migrate-container2">
       <label><ImLocation/><span className="spantag">Flying from</span>
     <input  className="migrate2"  type="text"/>
       </label>
   </div>

<button className="swapbtn2"><MdOutlineSwapHoriz/></button>
   <div className="migrate-container2">
       <label><ImLocation/> <span className="spantag">Flying to</span>
        <input  className="migrate2"  type="text"/>
       </label>
   </div>
...
<div className="maindisplaybox2">
    ...
    <div className="afternoonbox">
        <div className="morning">
            <p className="dayicon"><WiSunset/></p>
            <p className="day">Afternoon</p>
            <p className="time">(12:00-17:59)</p>
            </div>
        <div className="morning" style={{marginLeft:"10px"}}>
        <p className="dayicon"><WiDayHaze/></p>
    ...
    <div>
            <span style={{fontWeight:"bold"}} className="infoflight">Choose departing flight<MdKeyboardArrowRight/></span><span className="infoflight">Choose Returning Flight<MdKeyboardArrowRight/></span> <span className="infoflight">Review your trip</span>
        </div>
        <hr/>
        <div className="text-select">
            <div style={{fontSize:"12px"}}>Prices displayed include taxes and may change based on availability. You can review any additional fees before checkout. Prices are not final until you complete your purchase.</div>
            <div >
...
return <div className="card" key={e.id}>
    ...
    <div className="1stdiv ">
        <div className="timediv">{e.stime}-{e.etime}</div>
        <div className="durationdiv">{e.time}</div>
        <div className="pricediv"> Rs{e.price}</div>
    </div>
    <p style={{fontSize:"12px",paddingLeft:"509px"}}>Return per traveller</p>

<div className="destination">{e.dest}</div>
<div className="logoflightname">
<div ><img src={e.logo} alt="" className="logo"/></div>
<div className="flightname">{e.pname}</div>
</div>
<div className="safety">{e.safe}</div>
...
{/* <div className="firstdiv">
    ...
    <p style={{fontSize:"5px"}}>{e.dest}</p>
    <div>{e.dest}</div>
    
    
</div>
<div className="secdiv">{e.time}</div>
<div className="thirddiv">
    <div>Rs{e.price}</div>
    <p style={{margin:"0%"}}>Return per traveller</p>
</div> */}
