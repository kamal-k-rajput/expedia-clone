    ...
    <>
      <div id="all">
        <div id="pa1">
          <div id="p2">
            <div id="1">
              <h2>Who is flying?</h2>
              <p>
                Traveller names must match your government-issued photo ID
                exactly.
              </p>
            </div>
            <hr />
          ...
          <div id="bd">
            ...
            <p>
              ...
              Terms of Use Opens in a new window.. We use secure transmission
              and encrypted storage to protect your personal information.This
              payment will be processed in India. This does not apply when the
        ...
        <div id="pa2">
          ...
          <div id="ca2">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTlHflujp5xw_SEWtRJACkI2Z4BAfnVkMTVA	&#38;usqp=CAU"
              alt=""
            />
          </div>
          <hr />
