        ...
        <div className="model">
          ...
          <div className="firstcontent">
              ...
              <div className="incdec-div">
                  <div> <button className="decbutton" onClick={()=>{
                      adultcountchange(-1)
                  }}>-</button></div>
                  <div>{adult}</div>
                  <div><button className="incdec-button" onClick={()=>{
                      adultcountchange(1)
                  }}>+</button></div>
              </div>
              ...
              <div className="incdec-div">
               ...
               <p className="airline-rule">Airline Age Rules <BsBoxArrowInUpRight/></p>

               <button className="donebtn" onClick={closepopup}>Done</button>
